...
export const EvaluateIcon = ({ className = '', size = 'md' }: IconProps) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6',
...
export const DecisionsIcon = ({ className = '', size = 'md' }: IconProps) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6',
...
export const TrainingIcon = ({ className = '', size = 'md' }: IconProps) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6',
...
export const BorrowersIcon = ({ className = '', size = 'md' }: IconProps) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6',
...
export const RiskIcon = ({ className = '', size = 'md' }: IconProps) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6',
